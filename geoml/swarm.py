...
class Particle:
    def __init__(self, size):
        ...
        self.velocity = _np.random.uniform(size=size)
...
class ParticleSwarmOptimizer:
    def __init__(self, dimension, pop_size=20, cognitive_constant=2,
                 social_constant=2, inertia=0.5, max_velocity=0.5,
                 verbose=True):
    ...
    def optimize(self, fitness, max_iter=100, patience=None, seed=None,
        ...
        for it in range(max_iter):
            ...
            for i, particle in enumerate(self.population):
                ...
                inertia = particle.velocity * self.inertia
