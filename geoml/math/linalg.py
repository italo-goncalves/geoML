...
"""Numerical linear-algebra machinery, held for the solvers that will need
it (matrix-free RBF interpolation, scalable GP solves). Nothing here is on a
hot path today; the helpers in everyday use are `geoml.math.tf`."""
