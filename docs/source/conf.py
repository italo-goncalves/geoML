...
project = 'geoml'
copyright = '2019, Ítalo Gomes Gonçalves'
...
latex_documents = [
    (master_doc, 'geoml.tex', 'geoml Documentation',
     'Ítalo Gomes Gonçalves', 'manual'),
]
